...
// import { TrendingUp, Globe, BarChart3, ArrowRight, Play, Star, Users, Shield } from 'lucide-react';
...
//             <span className="text-sm font-medium text-gray-700">50K+ Traders</span>
//           </div>
//         </div>
//       </div>
...
//                 Access global currency markets 24/7 with lightning-fast execution, 
//                 competitive spreads, and professional-grade trading tools.
//               </p>
//             </div>
...
//                 <div className="text-xs font-bold text-gray-400">REGULATED</div>
//                 <div className="text-xs font-bold text-gray-400">SECURE</div>
//                 <div className="text-xs font-bold text-gray-400">24/7 SUPPORT</div>
//               </div>
//             </div>
//           </div>
...
//                   <span className="font-semibold text-gray-800">Live Trading</span>
//                 </div>
...
//                   <div className="text-2xl font-bold text-gray-800">0.8ms</div>
...
//                 <span className="text-sm font-bold text-green-600">+0.12%</span>
//               </div>
//             </div>

//             <div className="absolute -bottom-4 -right-4 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-white/20 animate-pulse" style={{ animationDelay: '1s' }}>
//               <div className="flex items-center space-x-2">
