...
const SHPlans = () => {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-sky-100 via-blue-50 to-indigo-100 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className={`text-center mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <h2 className="text-2xl sm:text-[50px] font-bold text-gray-900 mb-6">
            Choose Your Perfect
            ...
            >
              ...
              {plan.popular && (
                <div className="absolute -top-7 left-1/2 transform -translate-x-1/2">
                  <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-6 py-1 rounded-full text-sm font-medium flex items-center gap-1 shadow-lg">
