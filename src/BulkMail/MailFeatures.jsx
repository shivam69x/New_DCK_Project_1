  ...
  const features = [
    {
      ...
      description: "Create stunning emails with our drag-and-drop editor featuring professional templates and responsive design."
    },
    {
      icon: <Users className="w-10 h-10 text-green-600" />,
      title: "Contact Management",
      description: "Organize and segment your audience with powerful contact management and smart list building tools."
    },
    {
      icon: <BarChart3 className="w-10 h-10 text-green-600" />,
      title: "Real-time Analytics",
      description: "Track opens, clicks, conversions and ROI with detailed reporting and actionable insights."
    },
    {
      icon: <Zap className="w-10 h-10 text-green-600" />,
      title: "Marketing Automation",
      description: "Set up automated email sequences, drip campaigns, and behavioral triggers to nurture leads effectively."
    },
    {
      icon: <Target className="w-10 h-10 text-green-600" />,
      title: "A/B Testing",
      description: "Optimize your campaigns with built-in split testing for subject lines, content, and send times."
    },
    {
      icon: <Calendar className="w-10 h-10 text-green-600" />,
      title: "Campaign Scheduling",
      description: "Plan and schedule your email campaigns in advance with optimal send time recommendations."
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-8 sm:px-12">
        ...
        <div className="text-center mb-12 ">
          ...
          <p className="text-[18px] text-[#0e3c47ca] max-w-2xl mx-auto">
            Everything you need to create, send, and optimize email campaigns that drive results and grow your business.
            "Professional email marketing tools for businesses of all sizes."
          </p>
        </div>
